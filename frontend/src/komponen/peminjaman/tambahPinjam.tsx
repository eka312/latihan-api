...
function TambahPinjam({ setShowTambah, getPeminjaman}: TambahProps) {
    ...
    const [anggotaList, setAnggotaList] = useState<{ idKey: string; nama: string }[]>([]);
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            await axios.post("http://127.0.0.1:8000/api/peminjaman", payload, {
                headers: { 
            ...
            console.error("Gagal menambahkan peminjaman:", error.message);
